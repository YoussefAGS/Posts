Map<String, String> separatePhoneAndDialCode(String phoneWithDialCode) {
  Map<String, String> foundedCountry = {};

  for (var country in Countries.allCountries) {
    String dialCode = country["dial_code"].toString();
    if (phoneWithDialCode.startsWith(dialCode)) {
      foundedCountry = country;
      break; // Stop the loop once the matching dial code is found
    }
  }
  ...
  if (foundedCountry.isNotEmpty) {
    ...
    // Return both dialCode and phoneNumber as a map
    return {
      "dialCode": dialCode,
