    ...
    case DioExceptionType.badResponse:
      if (error.response != null) {
        ...
        if (error.response!.statusCode == ResponseCode.UNAUTORISED) {
          // ShowToast.showToastErrorTop(message: "Sorry but You are not authorized You should login again");
          //  SharedPrefHelper.removeData(SharedPrefKeys.userInfo);
          //  SharedPrefHelper.clearAllSecuredData();
          // DioFactory.clearTokenFromHeader();
          //  getIt<GlobalKey<NavigatorState>>().currentState!.pushNamedAndRemoveUntil( AppRoute.mainScreen, (Route<dynamic> route) => false);
          //  isLoggedInUser=false;


          return ApiErrorModel(
            statusCode: ResponseCode.UNAUTORISED,
            message: ResponseMessage.UNAUTORISED, // Set to "unauthorized Error"
          );
        }
          ...
          return ApiErrorModel(
            statusCode: error.response!.statusCode ?? ResponseCode.DEFAULT,
