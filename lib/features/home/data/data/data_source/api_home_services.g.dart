...
part of 'api_home_services.dart';
...
class _ApiHomeServices implements ApiHomeServices {
  _ApiHomeServices(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<PostModel> addPost(
      {required AddNewPostRequestModel addNewPostRequestModel}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(addNewPostRequestModel.toJson());
